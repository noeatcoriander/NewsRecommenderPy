...
# 管理员浏览管理类，继承django框架的admin.ModelAdmin类，重写方法和属性定制管理界面
@admin.register(Userbrowse)  # 使用django框架的admin装饰器注册浏览模型到管理后台
class UserbrowseAdmin(admin.ModelAdmin):
    # 列表页面显示的数据
    list_display = ['user', 'news', 'savedate']
