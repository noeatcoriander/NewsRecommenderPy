...
# 基础点赞模型序列化类，继承django rest framework框架serializers.ModelSerializer类
...
# 关联查询点赞模型序列化类，继承基础点赞模型序列化类
class UserlikeJoinSerializer(UserlikeSerializer):
    # 自定义序列化属性，用户
