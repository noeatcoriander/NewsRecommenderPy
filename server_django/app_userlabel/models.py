...
# 基础兴趣标签模型序列化类，继承django rest framework框架serializers.ModelSerializer类
...
# 关联查询兴趣标签模型序列化类，继承基础兴趣标签模型序列化类
class UserlabelJoinSerializer(UserlabelSerializer):
    # 自定义序列化属性，用户
