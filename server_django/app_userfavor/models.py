...
# 基础收藏模型序列化类，继承django rest framework框架serializers.ModelSerializer类
...
# 关联查询收藏模型序列化类，继承基础收藏模型序列化类
class UserfavorJoinSerializer(UserfavorSerializer):
    # 自定义序列化属性，用户
