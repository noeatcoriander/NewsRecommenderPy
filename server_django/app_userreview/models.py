...
# 基础评论模型序列化类，继承django rest framework框架serializers.ModelSerializer类
...
# 关联查询评论模型序列化类，继承基础评论模型序列化类
class UserreviewJoinSerializer(UserreviewSerializer):
    # 自定义序列化属性，用户
