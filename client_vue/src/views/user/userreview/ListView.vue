      ...
      <el-row :gutter="30">
        ...
        <el-col :span="19">
          <div class="content-right">
            ...
            <div>
              <el-table ref="tableRef" :data="data.userreviewList" size="large"
                ...
                <el-table-column label="评论时间" prop="savedate" width="200"/>
                <el-table-column label="操作" width="180">
                  <template #default="scope">
                    <el-button link type="primary"
                               @click="router.push('/user/userreview/detail?userreviewid='+scope.row.id)">
                      查看
                    </el-button>
                    <el-button link type="primary"
                               @click="router.push('/user/userreview/update?userreviewid='+scope.row.id)">
                      修改
                    </el-button>
...
const loadData = () => {
  //请求数据
  request.get('/user/userreview/list', {
...
const doDelete = (selectIds, isBatch = false) => {
  ...
  //调用公共删除函数
  handleDeleteBatch(selectIds, '/user/userreview/doDelete', loadData)
}
