      ...
      <el-row :gutter="30">
        ...
        <el-col :span="19">
          <div class="content-right">
            ...
            <div>
              <el-table ref="tableRef" :data="data.userbrowseList" size="large"
                ...
                <el-table-column label="浏览时间" prop="savedate" width="200"/>
...
const loadData = () => {
  //请求数据
  request.get('/user/userbrowse/list', {
    params: { pageNum: data.pageNum, pageSize: data.pageSize }
  }).then(res => {
    data.userbrowseList = res.pageBean.list //点赞列表
...
const doDelete = (selectIds, isBatch = false) => {
  ...
  //调用公共删除函数
  handleDeleteBatch(selectIds, '/user/userbrowse/doDelete', loadData)
}
